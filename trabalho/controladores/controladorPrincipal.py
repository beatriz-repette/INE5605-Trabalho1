from controladores.controladorDoador import ControladorDoador
from telas.telaPrincipal import TelaPrincipal
from controladores.controladorDoacao import ControladorDoacao
...
class ControladorPrincipal:
    def __init__(self):
        ...
        self.__tela_sistema = TelaPrincipal(self)
